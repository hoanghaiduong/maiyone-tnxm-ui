...
function HeaderSlide() {
    ...
    "loadingClasses": "opacity-0"
                ...
                className="relative"
            >
                <div className="hs-carousel relative overflow-hidden w-full h-[30rem] md:h-[calc(100vh-106px)] md:h-[calc(100vh-106px)] bg-gray-100 rounded-2xl bg-neutral-800">
                    <div className="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
                        {services.map(x => (

                            <div className="hs-carousel-slide">
                                <div className="h-[30rem] md:h-[calc(100vh-106px)] md:h-[calc(100vh-106px)] flex flex-col bg-cover bg-center bg-no-repeat bg-[url('https://placehold.co/600x400/green/white')]">
