        ...
        <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full py-7">
            ...
            >
                ...
                <div className="flex items-center gap-x-2 ms-auto py-1 md:ps-6 md:order-3 md:col-span-3">
                    <button
                        type="button"
                        className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl border border-gray-200 text-black hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none border-neutral-700 hover:bg-white/10 text-white hover:opacity-50"
                    >
                        Đăng nhập
                    </button>
                    <button
                    ...
                    <div className="md:hidden">
                        <button
                            type="button"
                            className="hs-collapse-toggle size-[38px] flex justify-center items-center text-sm font-semibold rounded-xl border border-gray-200 text-black hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none text-white border-neutral-700 hover:bg-neutral-700"
                        ...
                        {navs.map((nav) => (
                            nav.sub ? (
                                ...
                                <div>
                                    ...
                                    <a
                                        className="relative inline-block text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 text-white"
                                        href={nav.slug}
                                        aria-current="page"
                                    >
                                        {nav.title}
