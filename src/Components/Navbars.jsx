                      ...
                      <div className="md:mx-6 lg:mx-8 md:bg-white md:rounded-lg md:shadow-md">
                        ...
                        <div className="py-1 md:p-2 md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                          <div className="flex flex-col">
                            {/* Link */}
                            <a
                              className="p-3 flex gap-x-4 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg"
                              href="#"
                            >
                              <svg
                                className="shrink-0 size-4 mt-1 text-gray-800"
                                xmlns="http://www.w3.org/2000/svg"
                                width={24}
                                height={24}
                                viewBox="0 0 24 24"
                          ...
                          <div className="mt-2 md:mt-0 flex flex-col">
                            <span className="ms-2.5 mb-2 font-semibold text-xs uppercase text-gray-800">
                              Customer stories
                            </span>
                            {/* Link */}
                            <a
                              className="p-3 flex gap-x-5 items-center rounded-xl hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                              href="#"
                            >
                              <img
                              ...
                              <div className="grow">
                                ...
                                <p className="mt-3 inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 group-hover:underline group-focus:underline font-medium">
                                  Learn more
                                  <svg
